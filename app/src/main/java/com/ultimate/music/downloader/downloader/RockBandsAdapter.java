...
public class RockBandsAdapter extends RecyclerView.Adapter<RockBandsAdapter.mViewHolder> {

    private ArrayList<Item> mList7;
    ...
    public RockBandsAdapter(ArrayList<Item> list) {
        mList7 = list;
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        Item currentItem = mList7.get(position);
