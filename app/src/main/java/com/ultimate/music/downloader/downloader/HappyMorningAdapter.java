...
public class HappyMorningAdapter extends RecyclerView.Adapter<HappyMorningAdapter.mViewHolder> {

    private ArrayList<Item> mList5;
    ...
    public HappyMorningAdapter(ArrayList<Item> list) {
        mList5 = list;
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        Item currentItem = mList5.get(position);
