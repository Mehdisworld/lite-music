...
public class GlobalMusicAdapter extends RecyclerView.Adapter<GlobalMusicAdapter.mViewHolder> {

    private ArrayList<Item> mList4;
    ...
    public GlobalMusicAdapter(ArrayList<Item> list) {
        mList4 = list;
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        Item currentItem = mList4.get(position);
