...
public class AfricaMusicAdapter extends RecyclerView.Adapter<AfricaMusicAdapter.mViewHolder> {

    private ArrayList<Item> mList6;
    ...
    public AfricaMusicAdapter(ArrayList<Item> list) {
        mList6 = list;
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        Item currentItem = mList6.get(position);
