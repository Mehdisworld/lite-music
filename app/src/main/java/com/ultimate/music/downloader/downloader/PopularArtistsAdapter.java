...
public class PopularArtistsAdapter extends RecyclerView.Adapter<PopularArtistsAdapter.mViewHolder> {

    private ArrayList<Item> mList2;
    ...
    public PopularArtistsAdapter(ArrayList<Item> list) {
        mList2 = list;
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        Item currentItem = mList2.get(position);
